...
if ( function_exists ('register_sidebar') )
  register_sidebar( array(
    'name' => __( 'Header Widgets Area', 'sIresponsive-child' ),
    'id' => 'sidebar-header',
    'description' => __( 'Header widgets area for my child theme.' ,  'sIresponsive-child' ),
    'before_widget' => '<aside id="%1$s" class="widget %2$s four columns" style="margin-top: 25px;">',
    'after_widget' => '</aside>',
...
<div id="breadcrumb" class="row" style="font-size: 0.85em;"><!-- Bloglow breadcrumb navigation without a plugin v1.0 - http://bloglow.com/plugins/display-wordpress-breadcrumb-navigation-without-a-plugin/ -->';
